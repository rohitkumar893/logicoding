...
const ReactTutorials: React.FC<Props> = ({ selectedKey }) => {
  switch (selectedKey) {
    ...
    case 'react-setup':
      return <p className='text-xl'><b>React Setup:</b>
      
      </p>;
    case 'react-components':
      return <p className='text-xl'><b>React Components:</b><br /><br />
      Components are independent and reusable bits of code. They serve the same purpose as JavaScript functions, but work in isolation and return HTML.
      Components come in two types, Class components and Function components.<br /><br />
      Class Component
